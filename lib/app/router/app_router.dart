...
// Matches + roommate-requests feature pages disabled (kept for future re-enable).
...
import '../../features/admin/presentation/pages/admin_free_spots_page.dart';
...
class AppRouter {
  ...
  Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      // Matches + roommate-requests routes disabled. Flow replaced with
      // admin-approved seat applications.
